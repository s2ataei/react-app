...
const resume = props => (
    <div className="resume">
        ...
        <h1>Awards</h1>
        <ul className="awards">
            <li><a href="https://www.ryerson.ca/engineering-architectural-science/current-undergraduate/honours-recognition/" target="_blank">
                Dean's List Distinction</a></li>
            <li><a href="https://www.ryerson.ca/graduate/future-students/financing-your-studies/scholarships-awards/ryerson-graduate-fellowships/" target="_blank"> 
                Ryerson Graduate Fellowship Award</a></li>
            <li><a href="https://www.mitacs.ca/en/programs/accelerate" target="_blank">
        ...
        <p>Full-time role at <a href="https://wolf.ca" target="_blank">WOLF Advanced Technology. </a> </p>
        <p>
